...
final class Mercury_Bootstrapper_Plugin {
	...
	private function load_dependencies(): void {
		...
		require_once MERCURY_BOOTSTRAPPER_DIR . 'includes/steps/class-config-complianz-step.php';
	...
	private function register_steps(): void {
		...
		$this->runner->register_step( new Mercury_Bootstrapper_Config_Complianz_Step() );
